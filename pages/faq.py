...
def faq():
    ...
    faq_data = {
        ...
        Longer answer: The GEDCOM file is read into a temporary file and deleted immediately after its parsing. Furthermore, the app is deployed Streamlit Cloud where data is ephemeral and files are removed upon changing the state of the app (i.e. refreshing) or closing the browser tab.',
